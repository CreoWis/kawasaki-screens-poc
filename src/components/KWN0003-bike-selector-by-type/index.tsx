...
import { KWN0003BikeSelectorByTypeProps } from "./types";
import "./styles.css";

export const KWN0003BikeSelectorByType = ({
  data,
}: {
  data: KWN0003BikeSelectorByTypeProps;
}) => {
  const [bike, setBike] = useState<string>("");
  const { title, subtitle, selectTitle, bikeOptions } = data ?? {};
